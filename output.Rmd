...
Among FPMRS prescribing at least 10 opioid claims in the Part D Prescriber PUF, a total of `r total_count$total_claim_count` opioid claims were prescribed to `r total_count$total_bene_count` beneficiaries (Table 1).  Each FPMRS prescribed to a mean (SD) of `r stats_claims$mean_claim` (`r stats_claims$sd_claim`) opioid claims to a mean of `r stats_claims$mean_bene` (`stats_claims$sd_bene`) beneficiaries.  

Each beneficiary received a mean of `r round(stats_claims$mean_claim/stats_claims$mean_bene,1)` opioid claims, with a supply lasting a mean of 6.8days.  
